...
class Attendance:
    def __init__(self, root):
        ...
        #second image
        img1 = Image.open(r"college_images\stu_1.jpg")
        ...
        #Background image
        img2 = Image.open(r"college_images\un.jpg")
        ...
        title_lbl = Label(f_lbl, text = "ATTENDANCE MANAGEMENT SYSTEM", font=("times new roman" ,35, "bold"), bg = "white", fg = "blue")
        ...
        img_left = Image.open(r"college_images\ghi.jpeg")
        ...
        reset_btn = Button(btn_frame,command=self.reset_data, text = "Reset",width= 17,font=("times new roman" ,12, "bold"), bg="blue", fg="white")
