...
class Student:
    def __init__(self, root):
        ...
        #first image
        img = Image.open(r"C:\Users\as787\OneDrive\Desktop\VS CODE\college_images\stu_1.jpg")
        ...
        #second image
        img1 = Image.open(r"C:\Users\as787\OneDrive\Desktop\VS CODE\college_images\AdobeStock_303989091.jpeg")
        ...
        # third image
        img2 = Image.open(r"C:\Users\as787\OneDrive\Desktop\VS CODE\college_images\face-recognition.png")
        ...
        # background image
        img3 = Image.open(r"C:\Users\as787\OneDrive\Desktop\VS CODE\college_images\atten.png")
        ...
        img_left = Image.open(r"C:\Users\as787\OneDrive\Desktop\VS CODE\college_images\ghi.jpeg")
       ...
       #Department
        ...
        course_combo["values"] = ("Select Course","NLP","D.L", "PYTHON", "S.E", "C.O.A", "B.E","T.E","FLUID MECHANICS")
        ...
        img_right = Image.open(r"C:\Users\as787\OneDrive\Desktop\VS CODE\college_images\student-portal_1.jpg")
        ...
        show_btn = Button(search_frame, text = "Show All", width= 12,font=("times new roman" ,12, "bold"), bg="blue", fg="white")
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_stdname.get() == "" or self.var_std_id.get() =="":
            ...
            try:
                conn = mysql.connector.connect(host = "localhost",user ="root", passwd = "Akshat123", database = "facerecog")
